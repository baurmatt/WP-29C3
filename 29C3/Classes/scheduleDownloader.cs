...
namespace _29C3
{
    public class scheduleDownloader
    {
        ...
        /// </summary>
        private static readonly string scheduleURL = "http://events.ccc.de/congress/2012/Fahrplan/schedule.en.xml";

        /// <summary>
        /// Property which holds the schedules version URL
        /// </summary>
        private static readonly string scheduleVersionURL = "http://events.ccc.de/congress/2012/Fahrplan/index.en.html";
        ...
        public void GetScheduleVersion(Action<Exception, string> DownloadScheduleVersionCallback)
        {
            ...
            this._WebClient.DownloadStringCompleted += delegate(object sender, DownloadStringCompletedEventArgs e)
            {
                try
                {
                    ...
                    Match match = Regex.Match(e.Result, @"<p\sclass=""release"">.*?Version\s(.*?)</p>");
